    ...
    return (
        ...
        <Layout>
            ...
            <div className="container px-5 py-24 mx-auto">
                ...
                <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Click on a topic of your choice and start talking. Try with something simple like "What exactly is X?" and then move on. 
                Disclaimer: All the chatbots are GPT-3 driven hence please do a factual check before quoting the data on a public forum.</p>
                </div>
